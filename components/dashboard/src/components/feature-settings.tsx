...
export class FeatureSettings extends React.Component<FeatureSettingsProps, FeatureSettingsState> {
    ...
    render() {
        return <Grid xs={12}>
            <div><small>Enabling the feature preview gives you access to Gitpod's latest functionality and features. Some of those you'll notice immediately, others operate behind the scenes. <i>Here be dragons.</i></small></div>
